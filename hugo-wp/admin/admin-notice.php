...
<div class="hugo-admin-big-notice--container">
    ...
    wp_localize_script( $hugo_wp_slug , 'hugo_wp_builder_status', array(
        ...
        'hugo_wp_front_set_predesign_nonce' =>  wp_create_nonce( 'hugo_wp_front_set_predesign_nonce' ),
        'hugo_wp_disable_big_notice_nonce' => wp_create_nonce( 'hugo_wp_disable_big_notice_nonce' ),
